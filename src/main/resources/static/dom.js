...
export const inputTeam = document.getElementById(`inputTeam`);

export const updateName = document.getElementById(`updateName`);
export const updateId = document.getElementById(`updateId`);
export const updateShirtNumber = document.getElementById(`updateShirtNumber`);
